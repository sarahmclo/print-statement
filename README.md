...
| Bug ID | Bug Description                                                                              | Steps to Reproduce                              | Expected Behavior                                                                | Actual Behavior                                                                | Fix Description                                                                 | Status (Fixed/Unfixed) |
|--------|----------------------------------------------------------------------------------------------|------------------------------------------------|----------------------------------------------------------------------------------|--------------------------------------------------------------------------------|--------------------------------------------------------------------------------|------------------------|
| 1      | **Welcome banner not displaying correctly**                                                  | Run the program                                | Welcome banner should display correctly with color formatting.                  | Welcome banner is not displaying or formatting is incorrect.                  | Corrected the text formatting and ensured the color codes are applied properly. | Fixed                  |
| 2      | **Clear screen function not working**                                                        | Call `clearScreen` function                    | The screen should be cleared properly.                                           | The screen does not clear.                                                     | Implemented the clear screen functionality based on the OS.                     | Fixed                  |
| 3      | **Typing effect not displaying correctly in `typingPrint`**                                   | Call `typingPrint` function                    | Text should be displayed with a typing effect.                                   | Text displays instantly without the typing effect.                             | Adjusted the delay timing and ensured correct text rendering.                  | Fixed                  |
| 4      | **Invalid menu option handling fails**                                                       | Enter invalid menu option                      | Invalid input should display an error message and prompt again.                 | Program crashes or does not prompt again.                                      | Added error handling for invalid inputs in the menu selection.                 | Fixed                  |
| 5      | **Sales data not updating in Google Sheet**                                                  | Update sales data                              | Sales data should update correctly in the "Market Sales" sheet.                 | Data is not updated in the Google Sheet.                                       | Fixed the API call to update data in the Google Sheet correctly.               | Fixed                  |
| 6      | **Stock data not displaying correctly**                                                      | View stock data                                | Stock data should display correctly in a table format.                          | Stock data is displayed incorrectly or not at all.                             | Corrected data fetching and formatting logic for stock data.                   | Fixed                  |
| 7      | **Program does not exit properly**                                                           | Select "Exit Program"                          | Program should exit and display the exit message.                               | Program hangs or does not exit properly.                                       | Fixed the exit handling logic to ensure proper termination of the program.     | Fixed                  |
| 8      | **Materials data update crashes with invalid input**                                         | Provide invalid input for updating materials   | Invalid input should display an error message and prompt again.                 | Program crashes or does not handle the invalid input properly.                 | Added input validation and error handling for updating materials data.         | Fixed                  |
| 9      | **Main menu does not display after updating data**                                           | Update any section's data                      | User should be prompted to return to main menu or exit.                         | Program does not prompt for main menu or exit.                                 | Ensured prompt is displayed after data update.                                 | Fixed                  |
| 10     | **Google Sheet not updating correctly after changes**                                        | Make changes to data                           | Google Sheet should reflect the updated data correctly.                         | Changes are not reflected in the Google Sheet.                                 | Fixed the synchronization issue between the application and Google Sheet.      | Fixed                  |
